...
public class GrabMain
{
	public static SqlSessionFactory getSqlSessionFactory()
	   ...
	   {
		  System.out.println("***** contract : GrabMain run start *****");	 
	      HdacContract mainGrab = new HdacMainGrab();
	      mainGrab.setSqlSessionFactory(getSqlSessionFactory());
	      mainGrab.run();
	      System.out.println("***** contract : GrabMain run finish *****");	
	   }
}
