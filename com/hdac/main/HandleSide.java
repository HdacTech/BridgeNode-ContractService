...
public class HandleSide 
{
	public static SqlSessionFactory getSqlSessionFactory()
	   ...
	   {
		  System.out.println("***** contract : HandleSide run finish *****"); 
	      HdacContract sideHande = new HdacSideHandle();
	      sideHande.setSqlSessionFactory(getSqlSessionFactory());
	      sideHande.run();
	      System.out.println("***** contract : HandleSide run finish *****");
	   }
}
