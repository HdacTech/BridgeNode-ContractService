...
public class GrabSide
{
	public static SqlSessionFactory getSqlSessionFactory()
	   ...
	   {
		  System.out.println("***** contract : GrabSide run start *****");
	      HdacContract sideGrab = new HdacSideGrab();
	      sideGrab.setSqlSessionFactory(getSqlSessionFactory());
	      sideGrab.run();
	      System.out.println("***** contract : GrabSide run finish *****");	
	   }
}
