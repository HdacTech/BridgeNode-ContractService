...
public class RefundMain 
{
	public static SqlSessionFactory getSqlSessionFactory()
	   ...
	   {
		  System.out.println("***** contract : RefundMain run start *****");
	      HdacContract mainRefund = new HdacMainRefund();
	      mainRefund.setSqlSessionFactory(getSqlSessionFactory());
	      mainRefund.run();
	      System.out.println("***** contract : RefundMain run finish *****");
	   }
}
